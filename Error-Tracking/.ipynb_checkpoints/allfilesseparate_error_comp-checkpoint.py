    ...
    if file_name.endswith(".log"):
        ...
        def save_to_pdf(output_filename, waferid, log_content, errors, nochiperrors, scan_chain, analog_scan, digital_scan, vdd, register_error, daq_func_prog_term, prog_err, daq_digital, dac_calibration, temps, ldo, iref, threshold, overvoltage, data_merging, testing_message, dead_pixels, other_errors, plot_filename):
            ...
            text_content = [
                ...
                "------",
                f'There were {str(len(errors)+len(nochiperrors))} total error messages and {real_errors} actual errors in 1 wafer. {repeats} were repeats and will not be shown below.',
        ...
        time.sleep(1) #if you don't have this, it may overwrite some files as it creates them due to the naming convention of the pdfs
